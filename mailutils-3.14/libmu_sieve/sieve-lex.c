...
#define yy_create_buffer mu_sieve_yy_create_buffer
#define yy_delete_buffer mu_sieve_yy_delete_buffer
#define yy_flex_debug mu_sieve_yy_flex_debug
#define yy_init_buffer mu_sieve_yy_init_buffer
#define yy_flush_buffer mu_sieve_yy_flush_buffer
#define yy_load_buffer_state mu_sieve_yy_load_buffer_state
#define yy_switch_to_buffer mu_sieve_yy_switch_to_buffer
#define yyin mu_sieve_yyin
#define yyleng mu_sieve_yyleng
#define yylex mu_sieve_yylex
#define yylineno mu_sieve_yylineno
#define yyout mu_sieve_yyout
#define yyrestart mu_sieve_yyrestart
#define yytext mu_sieve_yytext
#define yywrap mu_sieve_yywrap
#define yyalloc mu_sieve_yyalloc
#define yyrealloc mu_sieve_yyrealloc
#define yyfree mu_sieve_yyfree
...
#define YY_USER_ACTION							\
  do									\
    {									\
      mu_linetrack_advance (trk, &yylloc, mu_sieve_yytext, mu_sieve_yyleng);		\
...
YY_DECL
{
	...
	{
#line 245 "sieve-lex.l"

         /* C-style comments */
#line 1072 "sieve-lex.c"
...
case 36:
YY_RULE_SETUP
#line 317 "sieve-lex.l"
return mu_sieve_yytext[0];
	YY_BREAK
case 37:
YY_RULE_SETUP
#line 319 "sieve-lex.l"
ECHO;
	YY_BREAK
#line 1364 "sieve-lex.c"
...
{
  char *p;
  yylval.number = strtoul (mu_sieve_yytext, &p, 0);
  switch (*p)
    {
    case 'k':
    case 'K':
