...
mu_errname (int e)
{
  ...
  switch (e)
    ...
    case EOK:
      ...
      case MU_ERR_TRANSPORT_GET:
        return "MU_ERR_TRANSPORT_GET";

      case MU_ERR_TRANSPORT_SET:
...
mu_strerror (int e)
{
  switch (e)
    ...
    case MU_ERR_SET_TIMEOUT:
      return _("error setting timeout");
    ...
    case MU_ERR_TRANSPORT_GET:
      return _("can't get transport descriptor");

    case MU_ERR_TRANSPORT_SET:
      return _("can't set transport descriptor");
